The code in this project searches for a pattern in a text file. Three types of search methods are used :
 ...
 bring down the average search time to linear or even sublinear in the case of Boyer Moore.
 ...
 naive approach as the strings already processed and their occurance counts stored in the hash map, so
